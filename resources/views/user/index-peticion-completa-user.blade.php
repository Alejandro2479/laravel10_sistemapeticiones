...
@section('title', 'Índice Completos')

@section('contenido_principal')
    <div class="md:ml-64">
        <div class="p-4">
            <div class="flex flex-col md:flex-row md:justify-between">
                <h2 class="text-2xl font-semibold mb-4">Lista de Derechos de Peticion Completos</h2>
            ...
            <div class="overflow-x-auto">
                <table class="w-full table-auto">
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr>
                            <td class="border px-4 py-2" colspan="7">No hay derechos de peticion completos</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
