        ...
        <div class="p-4">
            <div class="flex flex-col md:flex-row md:justify-between">
                ...
                <form class="flex items-center space-x-2 mb-4 md:mb-0" method="GET" action="{{ route('user.peticion-index') }}">
                    ...
                    <a class="rounded py-1 px-2 text-sm font-semibold text-slate-500 ring-1 ring-slate-500 hover:bg-slate-50 duration-500" href="{{ route('user.peticion-index') }}">Limpiar</a>
                </form>
            </div>
